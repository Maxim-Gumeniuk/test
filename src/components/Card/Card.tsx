...
const Card: FC<Props> = ({ item }) => (
    <div className="bg-white rounded-lg w-[318px] md:w-[438px] flex h-[212px] md:h-[336px] mb-10">
        ...
        <div className="px-2 pt-2 md:px-8 md:pt-10 flex flex-col gap-3 text-[#353844]">
